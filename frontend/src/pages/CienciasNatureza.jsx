...
function CienciasNatureza() {
  ...
  const carregarTrabalhos = async () => {
    try {
      const response = await listarTrabalhos('Ciencias_Natureza');
  ...
  return (
    <Container>
      <div className="text-center mb-4">
        <h1 className="display-5">🔬 Ciências da Natureza</h1>
...
export default CienciasNatureza;